...
<table width="100%" border="1" cellspacing="0" cellpadding="0" class="table table-dark">
    <tr>
    ...
    <?php
    $n=1;
    $query=mysqli_query($koneksi,"select* from berita inner join kategori on
    berita.id_kategori=kategori.id_kategori order by berita.id_berita desc");
    ...
    <tr>
        ...
        <td width="18%"><?php echo "<a href=perintah/kelola_berita.php?aksi=hapus&id_berita=$berita[id_berita]> <button> Hapus </button></a>"; ?></td>
    </tr>
    <?php
    $n++; }
    ?>
